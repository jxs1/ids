...
With the above in mind, it is now possible to define a multiset container without issue. We do so using a higher inductive type (see \textbf{4.2.5}) defined by Thorsten Altenkirch\cite{lyon}:\\
\\
